...
const About = () => {
  return (
    <section className="px-5 py-10 mt-38 max-md:mt-20 md:size-full flex gap-2 max-md:flex-col md:justify-between items-center">
      <div className="flex flex-col h-full flex-1 justify-between max-md:w-full max-md:items-center">
        ...
        />
        <h1 className="font-italiana max-sm:text-5xl text-7xl md:w-80 text-balance max-md:order-1 sm:w-[30rem] max-md:mb-10 max-md:text-center">
      ...
      <div className="h-full flex-1 md:w-1/3 flex flex-col justify-between items-center md:items-end">
        <div className="flex flex-col gap-5 text-balance max-md:items-center max-md:mb-10">
          <p className="md:w-[15rem] pr-8 max-md:text-center">
        ...
        <div className="w-full max-md:h-80 flex max-sm:flex-col max-md:gap-5 md:flex-row md:justify-end">
          <Image
